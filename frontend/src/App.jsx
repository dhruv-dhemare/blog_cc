...
import { createApiClient, formatDate } from './utils/api';

// Create API Context
export const ApiContext = createContext();

// Base URL - Separate configuration
...
function App() {
  ...
  // Create API client with the base URL
  ...
  return (
    <ApiContext.Provider value={{ apiClient, API_BASE_URL }}>
